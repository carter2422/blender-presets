...
kmi = km.keymap_items.new('view3d.viewnumpad', 'TWO', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('paint.brush_select', 'C', 'DOUBLE_CLICK')
kmi_props_setattr(kmi.properties, 'paint_mode', 'SCULPT')
kmi_props_setattr(kmi.properties, 'sculpt_tool', 'CLAY_STRIPS')
kmi = km.keymap_items.new('brush.active_index_set', 'P', 'DOUBLE_CLICK')
kmi_props_setattr(kmi.properties, 'mode', 'sculpt')
kmi_props_setattr(kmi.properties, 'index', 14)
kmi = km.keymap_items.new('brush.active_index_set', 'S', 'DOUBLE_CLICK')
kmi_props_setattr(kmi.properties, 'mode', 'sculpt')
kmi_props_setattr(kmi.properties, 'index', 15)
kmi = km.keymap_items.new('sculpt.brush_stroke', 'LEFTMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'mode', 'NORMAL')
...
kmi = km.keymap_items.new('wm.search_menu', 'ACCENT_GRAVE', 'PRESS')
...
kmi = km.keymap_items.new('screen.animation_play', 'SPACE', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('object.select_all', 'A', 'PRESS', ctrl=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'toggle', True)
kmi = km.keymap_items.new('mesh.loop_select', 'SELECTMOUSE', 'PRESS', alt=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi_props_setattr(kmi.properties, 'toggle', False)
...
kmi = km.keymap_items.new('mesh.select_all', 'A', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'action', 'SELECT')
kmi = km.keymap_items.new('mesh.select_all', 'A', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'action', 'DESELECT')
...
kmi_props_setattr(kmi.properties, 'limit', True)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi = km.keymap_items.new('mesh.select_linked_pick', 'SELECTMOUSE', 'DOUBLE_CLICK', alt=True)
kmi_props_setattr(kmi.properties, 'limit', False)
kmi_props_setattr(kmi.properties, 'deselect', True)
